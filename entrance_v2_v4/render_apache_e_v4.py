"""AH-64E Guardian entrance preview, v4 (v3 plus the Spike wing deploy, shown in slow motion off the launcher).
...
q[0].save(os.path.join(OUT, 'apache_e_entrance_v4.gif'), save_all=True, append_images=q[1:], duration=int(1000 * STEP / 60), loop=0, optimize=True, disposal=1)
for k_, i in keys.items(): frames[i].save(os.path.join(OUT, f'ape4_{k_}.png'))
