...
FUSELAGE = cl([
    (17, 110), (19, 103), (24, 98), (30, 94), (36, 92),                                   # nose cap
    (42, 87), (48, 81), (54, 76), (60, 72), (64, 70),                                     # windscreen
    (75, 68), (100, 66), (140, 66), (160, 62), (168, 58), (175, 56),                      # cabin roof, doghouse
    (190, 55), (215, 55), (228, 54), (234, 55), (238, 58), (241, 66), (243, 74), (247, 79), (252, 81),  # cowlings
    (300, 80), (350, 79), (405, 77),                                                      # boom top
    (420, 64), (440, 46), (453, 34), (458, 31),                                           # fin leading edge
    (466, 33), (471, 37),                                                                 # fin tip
    (465, 48), (458, 58), (452, 69), (449, 76), (446, 82), (442, 87),                     # fin trailing edge
    (430, 89), (405, 93), (375, 96), (340, 99), (300, 106), (275, 111), (250, 118),       # boom underside
    (225, 124), (205, 128), (190, 131),
    (150, 132), (100, 132), (60, 132), (45, 133),                                         # belly
    (35, 131), (27, 128), (21, 122), (17, 115),                                           # chin
])
...
POD = cl([(118, 131), (170, 131), (170, 145), (118, 145)])
MOUNT = cl([(130, 124), (156, 124), (158, 131), (128, 131)])
